...
// DEFINITIVE FIX: This version is simplified to only render the page-specific
// content. It does NOT contain any layout elements like <aside> or <main>, as
// those are now handled by the parent layout and conversation page.
    ...
    <div className="flex-1 flex min-w-0">
      ...
      <aside className="bg-white/5 border-l border-white/10 p-6 flex-col gap-6 overflow-y-auto w-96 flex-shrink-0 hidden lg:flex">
         <div className="flex flex-col items-center justify-center h-full text-center text-brand-text-muted">
            ...
            <p className="text-lg font-medium">Client Context</p>
            <p className="text-sm">Select a client from the sidebar to see their details, campaigns, and properties here.</p>
        </div>
      </aside>
    </div>
  );
...
// The main export wraps the page content in Suspense for best practice.
