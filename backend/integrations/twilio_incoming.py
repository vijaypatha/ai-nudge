...
async def process_incoming_sms(from_number: str, to_number: str, body: str):
    """
    Process incoming SMS by identifying the recipient agent via the 'to_number'
    and then finding the client associated with that agent via the 'from_number'.
    """
    ...
    # 4. FAQ AUTO-REPLY (now correctly scoped to the identified user)
        ...
        try:
            ...
            if user_faqs:
                ...
                if faq_response:
                    ...
                    # CRITICAL early return to prevent orchestrator after auto-reply
                    return
        except Exception as e:
